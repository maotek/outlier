...
class CapsuleAutomaat:
    ...
    def laad_inhoud(self, inhoud_data):
        ...
        self.inhoud = pd.concat([self.inhoud, nieuwe_inhoud]).groupby('Speelgoed').count().reset_index()
    ...
    def trek_speelgoed(self):
        ...
        if not beschikbare_speelgoed.empty:
        ...
        self.inhoud.loc[self.inhoud['Speelgoed'] == beschikbare_speelgoed, 'Aantal'] += 1
