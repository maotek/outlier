...
class TestBakkerij(unittest.TestCase):
    ...
    def test_korting_klantenkaart(self):
        ...
        self.assertEqual(result, "De totaalprijs van uw bestelling is 8 euro.")
    ...
    def test_korting_hoeveelheid(self):
        ...
        self.assertEqual(result, "De totaalprijs van uw bestelling is 31.0 euro.")

    def test_onvoldoende_voorraad(self):
        # Test een bestelling met onvoldoende voorraad
        result = self.bakkerij.neem_bestelling_op(["Luikse Wafel", "Luikse Wafel", "Luikse Wafel", "Luikse Wafel", "Luikse Wafel", "Luikse Wafel"], "12345", False)
    ...
    def test_geen_gebakjes(self):
        ...
        self.assertEqual(result, "De totaalprijs van uw bestelling is 0 euro.")
    ...
    def test_meerdere_kortingen(self):
        ...
        self.assertEqual(result, "De totaalprijs van uw bestelling is 25.5 euro.")
